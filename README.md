...
> 🚀 **이 프로젝트를 처음 열었거나 이어받는 경우 → [`START_HERE.md`](START_HERE.md) 를 먼저 읽으세요 (2분)**
> 코드를 고치기 전에는 [`HANDOFF.md`](HANDOFF.md) 3절 "절대 깨뜨리면 안 되는 불변식"을 확인하세요.
...
| 문서 | 내용 |
|---|---|
| [`START_HERE.md`](START_HERE.md) | **처음 열었다면 여기부터** — 2분 오리엔테이션, 현재 상태, 이어받는 사람이 알아야 할 3가지 |
